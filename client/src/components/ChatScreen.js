...
import { AppBar, Toolbar, Avatar, Typography, Box, TextField, Stack, Link } from '@mui/material'
  ...
  return (
    ...
    >
      ...
      >
        <Toolbar>
          <Avatar
            src={`https://api.dicebear.com/7.x/initials/svg?seed=${name}&radius=50`}
      ...
      <Stack direction="row">
        ...
        />
        {/* <Link to = "http://meet.google.com/new"> */}
        <VideocamOutlinedIcon onClick={() => window.open("http://meet.google.com/new", '_blank')} 
          fontSize='large'
          sx={{marginRight: "5px", alignItems: "right" }}
